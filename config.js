...
const reports = [
  ...
  [
    `每个星期都有不一样事在我的身边发生，回头想想那些事，总是有些值得自我去学习回忆的，也许这些东西会和我在一齐，永远埋在我的脑海里。当年纪老的时候说不定想起这些事，那时候就会茫然的一笑，感觉那时候的我真的很幼稚，年轻，跟本就不明白什么，就明白成天在外面瞎混。说到这些感觉自我此刻有些远了，还是说此刻的我吧！自我已经出了学校，不在像以前那样的单纯了，感觉到自我的肩上的担子好重，在往后接踵而来的不仅仅是工作上的烦恼，生活上，家庭里的就慢慢的累积到自我的身上。也就是说在不知不觉中自我已经长大了不在以前那个动不动就爱哭，流鼻涕的那个小男孩了。也许这就是我在实习中的认识，要是没有这样的经历，估计我还没有那么深刻的认识。`,
  ],
  [
    `经过这次的实习，我对自我的专业有了更为详而深刻的了解，并且把它结合实际的经济生活中。应对许多十分棘手又无奈的问题，经过过去大学里所积累知识的，是远远不够的，因为那只是理论而已，我体会到了实际的工作与所学知识是有必须距离的，与应用知识的距离就更为遥远。今后需要针对处于实际环境进一步学习相关的知识。异常关注此刻的趋势，也许别人机会当作陷阱，可是自我必须要理智。我感到对自我感触最深的是，提高自我交际本事，跟别人合作。这段的实习时间虽然暂时的告一个段落，可是它留在我的是宝贵的经验，而不是一个简单的实习而已。我也会深深的感激学校能在毕业之前能够有一次这样的实习机会。`,
  ],
];
